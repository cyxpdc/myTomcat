...
final class HttpHeader {
	...
	public HttpHeader(String name, String value) {
		...
		this.setName(name.toLowerCase().toCharArray());
		this.setNameEnd(name.length());
	...
	public boolean equals(HttpHeader header) {
		return (equals(header.getName(), header.getNameEnd()));
	}
	...
	public boolean headerEquals(HttpHeader header) {
		return (equals(header.getName(), header.getNameEnd())) && (valueEquals(header.value, header.valueEnd));
	}
