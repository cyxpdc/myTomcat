...
import com.pdc.tomcat.connector.RequestStream;

public class HttpRequest<K, V> implements HttpServletRequest {
	 ...
	 */
	protected static ArrayList<Object> empty = new ArrayList<Object>();
	/**
	...
	// HTTP请求头
	protected HashMap<Object, ArrayList<String>> headers = new HashMap<>();

	protected ParameterMap<K, V> parameters = null;
	...
	protected void parseParameters() {
		if (parsed)
			return;
		ParameterMap<K, V> results = parameters;// 新建一个map用来操作
		if (results == null)
			results = new ParameterMap<>();
		results.setLocked(false);// 解锁
		...
		// 若为post请求，则请求体会包含参数
		// 请求头"content-length"的值>0
		// "content-type"的值为"application/x-www-form-urlencoded"
