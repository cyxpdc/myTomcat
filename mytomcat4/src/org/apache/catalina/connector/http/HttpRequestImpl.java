...
final class HttpRequestImpl extends HttpRequestBase {
	...
	/**
	 * [Package Private] Set the InetAddress of the remote client of this
	 * request.
	 *
	 * @param inet
	 *            The new InetAddress
	...
	/**
	 * Return the fully qualified name of the client that sent this request, or
